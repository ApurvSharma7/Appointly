        ...
        <div className="flex-1 text-center md:text-left z-10 animate-fadeInUp">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <button
              ...
              className="px-8 py-3 bg-black text-white font-medium rounded-full shadow-lg hover:scale-105 hover:shadow-gray-300 hover:bg-gray-800 transition-all duration-300"
            >
              Our Services
            </button>
            <button
              onClick={() => handleNavigate("/doctors")}
              className="px-8 py-3 border border-gray-300 rounded-full font-medium text-gray-700 bg-white hover:bg-gray-50 hover:scale-105 transition-all duration-300"
            >
              Browse Doctors
            </button>
          </div>
