        ...
        <ul className="hidden md:flex items-center gap-8 text-gray-700 font-medium">
          {["HOME", "ALL DOCTORS", "ABOUT", "CONTACT", "SERVICES"].map((item, idx) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `relative transition-colors duration-300 hover:text-gray-600 ${
        ...
        <div className="flex items-center gap-4">
          {token && userData ? (
            ...
            <button
              ...
              className="bg-black text-white px-6 py-2 rounded-full shadow-md hover:bg-gray-800 hover:scale-105 transition-all duration-300 hidden md:block"
            >
              Create Account
            </button>
          )}
          ...
          <div className="w-64 bg-white h-full shadow-xl p-6 flex flex-col gap-6 animate-slideIn">
            ...
            {["HOME", "ALL DOCTORS", "ABOUT", "CONTACT", "SERVICES"].map((item, idx) => (
              <NavLink
                ...
                onClick={() => setShowMenu(false)}
                className="text-gray-700 font-medium hover:text-gray-600 transition-colors duration-300"
              >
                {item}
              </NavLink>
            ))}
            ...
            {!token && (
              <button
                ...
                className="bg-black text-white px-6 py-2 rounded-full shadow-md hover:bg-gray-800 transition-all duration-300"
              >
                Create Account
              </button>
            )}
