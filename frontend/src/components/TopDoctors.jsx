    ...
    <section className="relative py-20 px-6 md:px-16 overflow-hidden bg-gradient-to-b from-white via-blue-50 to-sky-50">
      ...
      <div className="relative text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800">
          Meet Our <span className="text-gray-600">Top Doctors</span>
        </h1>
      ...
      <div className="text-center">
        <button
          ...
          className="mt-14 px-10 py-3 bg-black hover:bg-gray-800 text-white rounded-full shadow-md hover:shadow-lg font-medium transition-all duration-300"
        >
          View More Doctors
        </button>
      </div>
