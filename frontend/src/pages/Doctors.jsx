              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="mb-5">
                    ...
                    <div className="flex items-center space-x-2 mt-2">
                      <div className="flex">
                        {Array.from({ length: 5 }, (_, i) => (
                          <span
                            key={i}
                            className={`text-sm ${
                              i < Math.round(doc.averageRating || 0) ? 'text-yellow-400' : 'text-gray-300'
                            }`}
                          >
                            ★
                          </span>
                      ...
                      <span className="text-sm font-medium text-gray-600">
                        {doc.averageRating ? doc.averageRating.toFixed(1) : '0.0'}
                      </span>
                      <span className="text-xs text-gray-500">
                        ({doc.totalRatings || 0} review{(doc.totalRatings || 0) !== 1 ? 's' : ''})
                      </span>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="mt-auto w-full bg-black text-white font-semibold py-3 rounded-lg hover:scale-[1.02] hover:shadow-lg hover:bg-gray-800 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                  >
                    Book Appointment
                  </button>
                </div>
